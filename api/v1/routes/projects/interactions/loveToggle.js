...
module.exports = (app, utils) => {
    app.post(
        ...
        async (req, res) => {
            ...
            const love = String(packet.toggle) === "true";
            ...
            if (!token || typeof love !== "boolean" || !projectID) {
                return utils.error(
                    res,
                    400,
                    "Missing username, token, love, or projectID",
                );
            }
            ...
            if (
                (await utils.UserManager.hasLovedProject(projectID, id)) &&
                love
            ) {
