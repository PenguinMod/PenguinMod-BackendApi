...
module.exports = (app, utils) => {
    const projectTemplate = fs
        .readFileSync(path.join(utils.homeDir, "project.html"))
        .toString();
    app.get("/:id", async function (req, res) {
        const json = await utils.UserManager.getProjectMetadata(
