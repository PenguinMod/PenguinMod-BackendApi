module.exports = (app, utils) => {
    app.get('/api/v1/projects/frontpage', async (req, res) => {
        ...
        */
        ...
        const featured = await utils.projects.getFeaturedProjects(0, utils.env.PageSize);
        ...
        const fitsTags = await utils.projects.searchForTag(tag, 0, utils.env.PageSize);
        const latest = await utils.projects.getProjects(0, utils.env.PageSize);
