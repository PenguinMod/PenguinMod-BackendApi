module.exports = (app, utils) => {
    app.get("/api/v1/users/scratchaddpassword", async function (req, res) {
        ...
        res.status(200);
        res.redirect(`http://localhost:5173/oauthchangepasswordintermediate?method=scratch&at=${response.access_token}`); //TODO: add page to on main site or smth for this 
